<template>
	<div class="add-task">
		...
		<div class="line"></div>
		<div>
			Вы установили прогресс выполнения задачи 100%,
			состояние текущей задачи перейдет стадию "Выполнено", только после согласования с инициаторам задачи.
			Отправить уведомление на почту инициатору о выполнении задачи?
		</div>
		<div slot="body">

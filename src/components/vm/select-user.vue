<template>
	<div class="add-task">
		<div style="margin-bottom: 10px; font-weight: bold;">Выбрать пользователя</div>
		<div>
			...
			<div style="display: flex;">
				<div>
					...
					<div v-show="visible"
						 ...
						 style="position: absolute; top: 194px; overflow: hidden;
...
export default {
	...
	methods: {
		...
		select() {
			this.$emit('close');
			this.$parent.$emit('select', this.userId);
